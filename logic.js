...
var firstPerson = 'Shravan'; // Replace with the actual name
var firstLocation = 'Bilaspur, India'; // Replace with the actual location

var secondPerson = 'Ayushi'; // Replace with the actual name
var secondLocation = 'Bilaspur, India';
...
var timeLeaveStamp = new Date(2023, 12, 31);

//first day of renewed contact (year, month, day)
var timeMeetStamp = new Date(2024, 12, 31);
